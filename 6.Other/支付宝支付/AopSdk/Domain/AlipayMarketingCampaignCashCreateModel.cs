...
namespace Aop.Api.Domain
{
    ...
    public class AlipayMarketingCampaignCashCreateModel : AopObject
    {
        ...
        /// <summary>
        /// 活动发放的现金总金额,最小金额1000.00元,最大金额10000000.00元。每个红包的最大金额不允许超过4999.99元。 实际的金额限制可能会根据业务进行动态调整。
        /// </summary>
        [XmlElement("total_money")]
        public string TotalMoney { get; set; }

        /// <summary>
        /// 红包发放个数，不同的发奖类型含义不同：  (1) 固定金额：活动总共发放的现金红包个数,最小100个,最大10000000个。 实际的个数限制可能会根据业务进行动态调整。  (2) 随机金额：用于计算每个随机红包的平均值，但最终发放个数不一定是total_num.
        /// </summary>
