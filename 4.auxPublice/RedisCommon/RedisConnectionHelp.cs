...
namespace RedisCommon
{
    ...
    public static class RedisConnectionHelp
    {
        ...
        /// 系统自定义Key前缀
        /// </summary>
        public static readonly string SysCustomKey = "Product:";

        /// <summary>
        /// 连接字符串
        /// </summary>
        private static readonly string RedisConnectionString = "127.0.0.1:6379,allowAdmin=true,password=zp365Redis_20";
