...
namespace DotNet.Utilities
{
    ...
    /// 15、HideMobileMiddleNumber(string number, int lenght, char hideChar)隐藏手机号中间号码
    /// </summary>
    public class StringHelper
    {
        ...
        /// <returns></returns>
        public static string HideMobileMiddleNumber(string number, int lenght, char hideChar)
        {
/*  
 *      length          result  
 *      0           18512345678  
